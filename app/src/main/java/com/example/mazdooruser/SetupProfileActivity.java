...
import static com.example.mazdooruser.Utils.hideKeyboard;
...
import com.example.mazdooruser.databinding.ActivitySetupProfileBinding;
...
//         binding.textCreate.setText("Authenticated ! Save the data");
                        ...
                        Toast.makeText(SetupProfileActivity.this, "Authentication failed.",
    ...
    private void uploadData(User user) {
        ...
        mRef.child(userId).setValue(user).addOnCompleteListener(task -> {
            if (task.isComplete() && task.isSuccessful()) {
                ...
                updateUI();
                Toast.makeText(SetupProfileActivity.this, "Account created successfully", Toast.LENGTH_SHORT).show();
            } else {
                dialog.dismiss();
                Toast.makeText(SetupProfileActivity.this, "Something went wrong! Try again", Toast.LENGTH_SHORT).show();
            }
        }).addOnFailureListener(e -> Toast.makeText(SetupProfileActivity.this, "Error adding data : " + e.getLocalizedMessage(), Toast.LENGTH_SHORT).show());
    }

    private void updateUI() {


        Intent i = new Intent(SetupProfileActivity.this, ProfileActivity.class);
